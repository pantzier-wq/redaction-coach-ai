...
function Dashboard() {
  ...
  async function refreshDashboardData() {
    ...
    const [profRes, essayRes] = await Promise.all([
      ...
      supabase.from("essays").select("*").order("created_at", { ascending: false }).limit(50),
    ]);

    if (profRes.error) console.error("Falha ao atualizar perfil:", profRes.error.message);
    if (essayRes.error) console.error("Falha ao atualizar histórico:", essayRes.error.message);
    if (profRes.data) setProfile(profRes.data);
    if (essayRes.data) {
      setEssays(
        essayRes.data.filter(
          (essay, index, all) => all.findIndex((item) => item.id === essay.id) === index,
        ),
      );
    }
  }
  ...
  if (loading) {
    return (
      <div className="authenticated-shell min-h-screen bg-[var(--paper)] text-[var(--ink)] flex items-center justify-center">
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 md:py-12 w-full overflow-hidden">
            ...
            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="text-center">
                ...
                <h1 className="font-['Fraunces'] text-5xl md:text-6xl font-black mb-6 tracking-tight text-[var(--ink)] leading-tight">
                  Olá,{" "}
                  <span className="text-[var(--red)] italic">
          ...
          {activeSection === "historico" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground mt-2">
                  Acompanhe sua evolução através das correções anteriores.
                </p>
              </div>
                      ...
                      <div className="flex justify-between items-center gap-4">
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="min-w-0">
                            <h3 className="font-bold truncate group-hover:text-[var(--red)] transition-colors pr-2 text-[var(--ink)]">
                              {essay.tema}
                            </h3>
                            <p className="text-[10px] md:text-xs text-[var(--ink-3)] font-medium">
                              {new Date(essay.created_at).toLocaleDateString("pt-BR")} •{" "}
                              {essay.redacao.length} caracteres
                            </p>
                          </div>
                        </div>
          ...
          {activeSection === "progresso" &&
            (profile?.is_pro ? (
              <ProgressSection
                essays={essays}
                onGoToCorrection={() => setActiveSection("correcao")}
              />
            ) : (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="max-w-2xl mx-auto text-center py-20">
                  <div className="p-6 rounded-3xl bg-[#EEF2F8] border-2 border-[#24365F]/20 mb-8 inline-block">
                    <TrendingUp className="w-16 h-16 text-[#24365F] animate-pulse" />
                  </div>
                  <h2 className="text-4xl font-black mb-4 tracking-tight">
                    Análise de Evolução Bloqueada 📈
                  </h2>
                  <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                    Acompanhe seu gráfico de notas e desempenho por competência em tempo real com o
                    Plano PRO.
                  </p>
                  <button
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="max-w-2xl mx-auto text-center py-12">
                ...
                <p className="text-xl text-[var(--ink-2)] mb-8 leading-relaxed font-medium">
                  ...
                  correções e ferramentas extras.
                </p>
                ...
                {profile?.is_pro && (
                  <div className="mb-12 rounded-3xl border border-[var(--line)] bg-[var(--paper-2)]/50 p-6 text-left shadow-sm">
                    <div className="flex items-center justify-between gap-4 mb-4">
                      <div>
                        <h3 className="text-lg font-black uppercase tracking-tight text-[var(--ink)]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      {[
                        ...
                        >
                          ...
                          <div className="text-sm font-black text-[#24365F]">{pack.preco}</div>
                          <div className="mt-2 rounded-lg bg-[#EEF2F8] px-2 py-1 text-[10px] font-black uppercase tracking-wide text-[#24365F] border border-[#24365F]/15">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left mb-12">
                  ...
                  <div className="flex flex-col rounded-3xl border border-[var(--line)] bg-[var(--paper-2)]/50 p-8 relative overflow-hidden group shadow-sm transition-all hover:bg-[var(--paper-2)]">
                    <div className="mb-6 flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-xl font-black text-[var(--ink)] leading-tight uppercase tracking-tight">
                          Plano Essencial
                        </h3>
                        <p className="text-xs font-bold text-[var(--ink-3)] leading-tight uppercase tracking-[0.1em]">
                          Vitalício • +12 correções
                        </p>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-3 mb-8 flex-1">
                      <li className="flex items-start gap-3 text-sm font-medium text-[var(--ink-2)]">
                        <span className="text-[#24365F] shrink-0 font-bold">✓</span>
                        <span>+12 correções de redação com IA</span>
                      </li>
                      <li className="flex items-start gap-3 text-sm font-medium text-[var(--ink-2)]">
                        <span className="text-[#24365F] shrink-0 font-bold">✓</span>
                      ...
                      <li className="flex items-start gap-3 text-sm font-medium text-[var(--ink-3)]">
                        ...
                        <span className="line-through italic">+25 correções</span>
                      </li>
                      <li className="flex items-start gap-3 text-sm font-medium text-[var(--ink-3)]">
                        <span className="text-[var(--red)] shrink-0 font-bold">✕</span>
                    ...
                    <div className="mt-auto">
                      <div className="flex items-baseline gap-2 mb-6">
                        <span className="text-lg font-bold text-[var(--ink-3)] line-through italic">
                          R$ 29,90
                        </span>
                  ...
                  <div className="flex flex-col rounded-3xl border-2 border-[var(--red)] bg-[var(--red)]/5 p-8 relative overflow-hidden group shadow-[0_20px_40px_-12px_rgba(196,50,42,0.15)] scale-[1.05]">
                    <div className="mb-6 flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-bold text-[var(--red)] leading-tight uppercase tracking-[0.1em]">
                          Acesso Total + Bônus
                        </p>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-4 mb-8 flex-1">
                      {[
                        {
                          t: "+25 correções de redação",
                          d: "Mais que o dobro de oportunidades para treinar e evoluir.",
                        },
                        {
                          t: "Laboratório de Conectivos",
                          d: "Amplie suas opções para conectar ideias com clareza.",
                        },
                        {
                          t: "Gerador de Repertório Coringa",
                          d: "Repertórios que encaixam em qualquer tema.",
                        },
                        {
                          t: "70+ Repertórios Legitimados",
                          d: "Biblioteca exclusiva validada por corretores.",
                        },
                        {
                          t: "Histórico Completo",
                          d: "Gráfico de evolução e acompanhamento nota a nota.",
                        },
                      ].map((b) => (
                        <li key={b.t} className="flex items-start gap-3">
                          <span className="mt-0.5 h-6 w-6 shrink-0 rounded-full bg-[var(--red)] text-white text-xs font-black flex items-center justify-center shadow-sm">
                            ✓
                          </span>
                          <div className="leading-tight">
                            <div className="text-sm font-black text-[var(--ink)]">{b.t}</div>
                            <div className="text-[11px] font-medium text-[var(--ink-2)] mt-0.5">
                              {b.d}
                            </div>
                          </div>
                        </li>
                    ...
                    <div className="mt-auto">
                      ...
                      <button
                        ...
                        className="w-full rounded-xl bg-[#16213A] py-5 text-sm font-black uppercase tracking-[0.15em] text-white shadow-[0_10px_20px_-5px_rgba(22,33,58,0.48)] transition-all hover:scale-[1.02] hover:bg-[#24365F] active:scale-95"
                      >
                        LIBERAR TUDO AGORA
                      </button>
                      <p className="mt-4 text-center text-[10px] font-black text-[var(--red)] uppercase tracking-[0.2em]">
                        Desconto de R$ 20,00
                      </p>
                    </div>

                    {/* Badge de destaque */}
                    <div className="pointer-events-none absolute right-[-52px] top-7 w-52 rotate-45 bg-[var(--red)] py-2 text-center text-[10px] font-black uppercase tracking-[0.18em] text-white shadow-md">
                      RECOMENDADO
                    </div>
                  </div>
                </div>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="mb-12">
                ...
                <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
                  Encontre repertórios de filosofia, sociologia, história, literatura, cinema,
                  legislação e cultura brasileira para fortalecer seus argumentos.
                </p>
                <div className="mt-8 p-6 rounded-2xl bg-card border border-border flex flex-col md:flex-row gap-6 items-center">
                  ...
                  <div>
                    <p className="text-[var(--ink)] font-medium italic leading-relaxed">
                      “Um bom repertório não serve apenas para deixar a redação mais bonita. Ele
                      deve ajudar a explicar o problema, comprovar seu argumento ou aprofundar sua
                      análise.”
                    </p>
                  </div>
                </div>
              ...
              <div className="mb-12 p-8 rounded-[2rem] border-2 border-[var(--red)]/20 bg-[var(--red)]/5 shadow-sm">
                <h2 className="font-['Fraunces'] text-2xl font-black mb-6 flex items-center gap-2 text-[var(--ink)]">
                  <AlertTriangle className="w-6 h-6 text-[var(--red)]" /> Antes de usar um
                  repertório
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    <h3 className="font-black text-[var(--ink)] uppercase text-xs tracking-widest">
                      Ele é verdadeiro?
                    </h3>
                    <p className="text-sm text-[var(--ink-2)] font-medium">
                      Não invente autores, frases, leis, filmes, pesquisas ou acontecimentos
                      históricos.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h3 className="font-black text-[var(--ink)] uppercase text-xs tracking-widest">
                      Ele combina com o tema?
                    </h3>
                    <p className="text-sm text-[var(--ink-2)] font-medium">
                      A referência precisa estar claramente relacionada ao problema discutido.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h3 className="font-black text-[var(--ink)] uppercase text-xs tracking-widest">
                      Ele fortalece seu argumento?
                    </h3>
                    <p className="text-sm text-[var(--ink-2)] font-medium">
                      Não basta citar. Depois de apresentar o repertório, explique o que ele
                      demonstra e como se conecta à sua tese.
                    </p>
                  </div>
                </div>
                <div className="mt-8 p-6 rounded-2xl bg-[var(--paper)] border border-[var(--line)] text-sm italic text-[var(--ink-3)] font-medium shadow-inner">
                  Repertório coringa não significa repertório automático. A referência precisa ser
                  adaptada ao tema e explicada dentro da argumentação.
                </div>
              </div>
              ...
              {profile?.has_full_access ? (
                ...
                <LockedLibraryOffer
                  ...
                  itens={[
                    ...
                    "+25 correções de redação",
                    "Laboratório de Conectivos + quiz e flashcards",
          ...
          {activeSection === "conectivos" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="mb-12">
                ...
                <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
                  Encontre conectivos para introduzir argumentos, acrescentar ideias, explicar
                  causas, apresentar consequências, fazer oposições e concluir sua redação.
                </p>
                <div className="mt-8 p-6 rounded-2xl bg-card border border-border flex flex-col md:flex-row gap-6 items-center">
                  <div className="p-4 rounded-xl bg-primary/5 text-primary shrink-0">
                  ...
                  <div>
                    <p className="text-foreground font-medium italic">
                      “Conectivos são palavras e expressões que ajudam a ligar as partes do texto.
                      Porém, não basta colocá-los aleatoriamente: cada conectivo deve representar
                      corretamente a relação entre as ideias.”
                    </p>
                    <div className="mt-4 flex items-center gap-2 text-[var(--red)] text-sm font-bold">
                      <AlertTriangle className="w-4 h-4" />
                      <span>
                        Importante: utilizar muitos conectivos não garante uma nota alta. O mais
                        importante é escolher o conectivo adequado para cada situação.
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {profile?.has_full_access ? (
                  ...
                  <div className="mb-12 p-8 rounded-[2rem] border-2 border-primary/20 bg-primary/5 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-muted-foreground text-sm font-bold mb-6 max-w-2xl">
                        Cole sua frase abaixo para que nossa IA analise se o conectivo está bem
                        aplicado ou sugira um melhor para o seu contexto.
                      </p>
                ...
                <LockedLibraryOffer
                  ...
                  itens={[
                    ...
                    "Laboratório de Conectivos: analisa sua frase e sugere o melhor",
...
function ConectivosIA() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const result = await analyzeFn({ data: { frase, sessionId: crypto.randomUUID() } });
      ...
      alert(
        message.includes("TOOL_LIMIT_REACHED")
          ? "Você atingiu o limite de 20 análises de conectivos de hoje. O acesso será renovado amanhã."
          : "A análise está temporariamente indisponível. Tente novamente em instantes.",
      );
      setIsAnalyzing(false);
      if (progressInterval.current) clearInterval(progressInterval.current);
    }
      ...
      {analise && (
        <div className="animate-in fade-in slide-in-from-top-4 duration-500 p-8 rounded-3xl border border-[var(--line)] bg-[var(--paper)] relative overflow-hidden shadow-sm">
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <div
                className={cn(
                  ...
                  analise.status === "bom" && "bg-[#EEF2F8] text-[#24365F] border-[#24365F]/20",
                  analise.status === "regular" &&
                    "bg-[var(--red-soft)] text-[var(--red)] border-[var(--red)]/20",
                  analise.status === "ruim" &&
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-[9px] font-black uppercase tracking-[0.2em] text-[var(--ink-3)] mb-1">
                  Análise Técnica
                </h4>
              ...
              {analise.sugestao && (
                <div className="p-6 rounded-2xl bg-[var(--paper-2)] border border-[var(--line)] relative shadow-inner">
                  ...
                  <h4 className="text-[9px] font-black uppercase tracking-[0.2em] text-[var(--red)] mb-2">
                    Sugestão de Upgrade
                  </h4>
              ...
              <p className="text-right text-[10px] font-black uppercase tracking-widest text-[var(--ink-3)]">
                {analise.remaining} análises disponíveis hoje
              </p>
            </div>
          </div>
        </div>
        ...
        {filtered.map((c, i) => (
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <h4 className="font-['Fraunces'] text-xl font-black text-[var(--red)] tracking-tight italic">
                {c.termo}
              </h4>
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="flex items-start gap-2">
                  <div className="mt-1 shrink-0">
                    <Check className="w-3 h-3 text-[#24365F]" />
                  </div>
                  <p className="text-[11px] text-[var(--ink-2)] font-bold italic">
                    <span className="text-[var(--ink)] not-italic font-black uppercase text-[9px] tracking-widest mr-1">
                      Uso:
                    </span>{" "}
                    {c.uso}
                  </p>
                ...
                <div className="flex items-start gap-2">
                  <div className="mt-1 shrink-0">
                    <Lightbulb className="w-3 h-3 text-[var(--red)]" />
                  </div>
                  <p className="text-[11px] text-[var(--ink-2)] font-bold italic">
                    <span className="text-[var(--ink)] not-italic font-black uppercase text-[9px] tracking-widest mr-1">
                      Dica:
        ...
        <div className="p-8 rounded-[2rem] border-2 border-[var(--red)]/20 bg-[var(--paper)] shadow-sm">
          ...
          <ul className="space-y-4">
            <li className="flex gap-3 items-start">
              <div className="w-6 h-6 rounded-full bg-[var(--red)]/10 flex items-center justify-center shrink-0 mt-0.5 text-[var(--red)] font-black text-xs border border-[var(--red)]/20">
                1
              </div>
              <p className="text-sm font-bold text-[var(--ink-2)]">
                <strong className="text-[var(--ink)]">Usar "mesmo" como pronome:</strong> "O aluno
                entregou a redação e o mesmo saiu." (Errado). Prefira: "ele".
              </p>
            </li>
            <li className="flex gap-3 items-start">
              <div className="w-6 h-6 rounded-full bg-[var(--red)]/10 flex items-center justify-center shrink-0 mt-0.5 text-[var(--red)] font-black text-xs border border-[var(--red)]/20">
              ...
              <p className="text-sm font-bold text-[var(--ink-2)]">
                <strong className="text-[var(--ink)]">Onde vs Aonde:</strong> "Onde" indica lugar
                fixo. "Aonde" indica movimento. Não use "onde" para substituir "no qual" em ideias
                abstratas.
              </p>
            </li>
          </ul>
...
function ConectivosTraining() {
  ...
  const questions = [
    {
      ...
      correct: 2,
      explanation:
        "'A fim de que' indica finalidade, conectando o investimento ao objetivo de evolução social.",
    },
    {
      ...
      correct: 1,
      explanation:
        "'Todavia' introduz uma oposição entre os benefícios e os problemas do uso excessivo.",
    },
    {
    ...
    },
    {
      ...
      correct: 1,
      explanation:
        "'No entanto' marca o contraste entre o direito garantido por lei e a realidade prática.",
    },
    {
      ...
      correct: 0,
      explanation:
        "'Dessarte' (ou Desse modo) é um conectivo conclusivo formal, ideal para a redação ENEM.",
    },
    {
    ...
    },
    {
      ...
      correct: 0,
      explanation:
        "'Embora' introduz uma concessão, indicando que algo acontece apesar das leis claras.",
    },
    {
    ...
    },
    {
      ...
      correct: 1,
      explanation:
        "'Afinal' reforça a ideia anterior, servindo como uma explicação ou justificativa.",
    },
    {
      ...
      correct: 0,
      explanation:
        "'Nesse contexto' situa a necessidade de combate ao desperdício dentro da crise citada.",
    },
    {
      ...
      correct: 1,
      explanation:
        "'Por outro lado' introduz uma visão contrastante ou complementar sobre o mesmo tema.",
    },
    {
      ...
      correct: 0,
      explanation:
        "'Contanto que' estabelece uma condição necessária para que a prática seja saudável.",
    },
    {
      ...
      correct: 1,
      explanation:
        "'Dessa forma' conecta a afirmação inicial à consequência ou exemplo prático citado.",
    },
    {
    ...
    },
    {
      ...
      correct: 0,
      explanation:
        "'Assim sendo' conclui que os problemas aparecem no cinema como reflexo da vida.",
    },
    {
      ...
      correct: 1,
      explanation:
        "'Contudo' marca a oposição entre a busca pela felicidade e a efemeridade do consumo.",
    },
    {
  ...
  if (currentStep >= questions.length) {
    return (
      <div className="p-8 rounded-[2.5rem] border-2 border-[#24365F]/20 bg-[var(--paper)] text-center shadow-sm">
        <div className="w-20 h-20 rounded-2xl bg-[#EEF2F8] flex items-center justify-center mx-auto mb-6 shadow-sm border border-[#24365F]/15">
          <Trophy className="w-10 h-10 text-[#24365F]" />
        </div>
        <h3 className="font-['Fraunces'] text-3xl font-black text-[#24365F] mb-2 italic">
        ...
        <button
          onClick={resetQuiz}
          className="px-8 py-5 rounded-2xl bg-[#24365F] text-white font-black text-[10px] uppercase tracking-[0.2em] hover:scale-105 transition-all shadow-lg"
        >
          TREINAR NOVAMENTE
        </button>
      </div>
  ...
  return (
    <div className="p-8 rounded-[2.5rem] border border-[var(--line)] bg-[var(--paper)] shadow-sm">
      <div className="flex justify-between items-center mb-6">
        <h3 className="font-['Fraunces'] text-xl font-black text-[#24365F] flex items-center gap-2 italic">
          <Play className="w-6 h-6" /> Treino de Conectivos ({currentStep + 1}/{questions.length})
        </h3>
        <div className="px-3 py-1 rounded-full bg-[#EEF2F8] text-[#24365F] text-[9px] font-black uppercase tracking-widest border border-[#24365F]/15 shadow-inner">
          Score: {score}
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !showFeedback &&
                  "border-[var(--line)] bg-[var(--paper)] text-[var(--ink)] hover:border-[#24365F]/50 hover:bg-[#EEF2F8]",
                showFeedback && isCorrect && "border-[#24365F] bg-[#EEF2F8] text-[#24365F]",
                showFeedback &&
                  isSelected &&
                  !isCorrect &&
                ...
                showFeedback &&
                  !isSelected &&
                  !isCorrect &&
                  "opacity-40 border-[var(--line)] bg-[var(--paper-2)]",
              )}
            >
              {opt}
        ...
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          >
            <div className="flex items-center gap-2 mb-2 font-black uppercase text-[10px] tracking-[0.2em]">
              {selectedOption === q.correct ? (
                <>
                  <Check className="w-4 h-4 text-[#24365F]" /> Excelente!
                </>
              ) : (
                <>
            ...
            <p className="text-sm font-bold text-[var(--ink-2)] italic">{q.explanation}</p>
          </div>
          ...
          >
            {currentStep === questions.length - 1 ? "VER RESULTADO" : "PRÓXIMA QUESTÃO"}{" "}
...
function RepertoriosLibrary() {
  ...
  const repertorios = repertoryLibrary;
  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[var(--paper)] p-8 rounded-[2.5rem] border border-[var(--line)] shadow-sm">
        <div>
          <h2 className="font-['Fraunces'] text-3xl font-black text-[var(--ink)] italic">
            Biblioteca de Repertórios
          </h2>
          <p className="text-[var(--ink-2)] mt-2 font-medium">
            Use modelos prontos ou crie um exclusivo com nossa IA.
          </p>
        </div>
        <button
      ...
      <div className="flex flex-col gap-6 p-6 md:p-10 rounded-[2.5rem] bg-[var(--paper)] border border-[var(--line)] shadow-sm">
        ...
        <div className="space-y-6">
          <div>
            <span className="text-[9px] font-black uppercase text-[var(--ink-3)] tracking-[0.2em] block mb-3 ml-1">
              Filtrar por Tipo
            </span>
              ...
              {eixos.map((e) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeEixo === e.id
                      ? "border-[#24365F] bg-[#24365F] text-white"
      ...
      <div className="grid grid-cols-1 gap-6">
        {filtered.map((r) => (
          <div
            key={r.id}
            className="p-8 rounded-[2.5rem] border border-[var(--line)] bg-[var(--paper)] hover:border-[var(--red)]/40 transition-all flex flex-col md:flex-row gap-8 shadow-sm group/card"
          >
            <div className="flex-1 space-y-6">
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="font-['Fraunces'] text-2xl font-black text-[var(--ink)] tracking-tight italic">
                    {r.titulo}
                  </h3>
                  <p className="text-[10px] font-black text-[var(--red)] uppercase tracking-[0.2em]">
                    {r.autorOuOrigem}
                  </p>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  <span className="text-[9px] font-black uppercase text-[var(--ink-3)] tracking-widest block mb-1">
                    Ideia Central
                  </span>
                ...
                <div className="p-6 rounded-2xl bg-[var(--paper-2)] border border-[var(--line)] relative group shadow-inner">
                  <span className="text-[9px] font-black uppercase text-[var(--red)] tracking-widest block mb-3">
                    Modelo Adaptável
                  </span>
                  <p className="text-sm font-bold italic text-[var(--ink)] leading-relaxed whitespace-pre-wrap">
                    ...
                    {r.modeloAdaptavel.split(/(\[.*?\])/).map((part, i) =>
                      part.startsWith("[") ? (
                        <span
                          key={i}
                          className="text-[var(--red)] font-black bg-[var(--red)]/10 px-1 rounded"
                        >
                          {part}
                        </span>
                      ) : (
                ...
                {r.alerta && (
                  <div className="flex items-start gap-2 text-[var(--red)] text-[10px] font-black uppercase tracking-tight p-3 rounded-xl bg-[var(--red-soft)] border border-[var(--red)]/20 shadow-sm">
            ...
            <div className="w-full md:w-64 space-y-4">
              <div className="p-6 rounded-2xl bg-[var(--paper-2)] border border-[var(--line)] shadow-inner">
                <span className="text-[9px] font-black uppercase text-[var(--ink-3)] tracking-widest block mb-3">
                  Eixos Temáticos
                </span>
                <div className="flex flex-wrap gap-2">
                  {r.eixosTematicos.map((e) => (
                    <span
                      key={e}
                      className="px-2 py-1 rounded-md bg-[var(--paper)] border border-[var(--line)] text-[9px] font-black uppercase tracking-tighter text-[var(--ink)] shadow-sm"
                    >
                      {e}
                    </span>
                  ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground font-bold">
              O estudante apresentou o conceito, mas não explicou sua relação com o tema.
            </p>
          </div>
          <div className="space-y-4">
            <h4 className="font-black text-[#22c55e] text-sm uppercase tracking-widest">
              Forma ideal
            </h4>
            <div className="p-4 rounded-xl bg-[#22c55e]/10 border border-[#22c55e]/20 text-xs italic">
              "Segundo Bauman, a modernidade líquida é marcada pela fragilidade das relações. Essa
              análise relaciona-se à exposição digital infantil, pois a busca por aprovação nas
              plataformas..."
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-300 py-4">
      <div className="text-center">
        ...
        <h3 className="font-['Fraunces'] text-2xl font-black text-[var(--ink)] italic">
          IA analisando seu tema
        </h3>
        <p className="text-sm font-bold text-[var(--ink-3)] mt-1">
        ...
        {REPERTORIO_LOADING_STEPS.map((label, i) => (
          <div
            ...
            className={cn(
              ...
              i < index
                ? "bg-[#EEF2F8] border-[#24365F]/20 text-[var(--ink)]"
                : i === index
          ...
          >
            {i < index ? (
              <Check className="w-4 h-4 text-[#24365F] shrink-0" />
            ) : i === index ? (
...
function RepertorioIA({ onClose }: { onClose: () => void }) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      alert(
        errorMsg.includes("TOOL_LIMIT_REACHED")
          ? "Você atingiu o limite de 10 sessões de repertório de hoje. O acesso será renovado amanhã."
          : "O gerador está temporariamente indisponível. Tente novamente em instantes.",
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[var(--paper)]/95 backdrop-blur-xl flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-[var(--paper)] border-2 border-[var(--line)] rounded-[3rem] shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]">
        <button
          onClick={onClose}
          className="absolute top-6 right-6 p-2 rounded-xl bg-[var(--paper-2)] border border-[var(--line)] hover:bg-[var(--line)] transition-colors z-10 shadow-sm text-[var(--ink)]"
        >
          <X className="w-6 h-6" />
        </button>
        ...
        <div className="p-8 md:p-12 overflow-y-auto">
          ...
          {!loading && step === 1 && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
              <div className="text-center">
                ...
                <h3 className="font-['Fraunces'] text-3xl font-black mb-2 text-[var(--ink)] italic">
                  Gerador de Repertório IA
                </h3>
                <p className="text-[var(--ink-2)] font-medium italic">
                  Vamos criar o repertório perfeito para o seu texto.
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <label className="text-[9px] font-black uppercase text-[var(--red)] tracking-widest block mb-2 ml-1">
                    Sobre o que é seu texto? (Tema)
                  </label>
                  <input
                    value={tema}
                ...
                >
                  {loading ? (
                    <div className="animate-spin rounded-full h-5 w-5 border-2 border-[var(--paper)]/30 border-t-[var(--paper)]" />
                  ) : (
                    <>
                      <Zap className="w-5 h-5 text-[var(--red)]" /> GERAR REPERTÓRIO AGORA
                    </>
                  )}
                </button>
              </div>
          ...
          {!loading && step === 3 && currentResponse?.repertorio && (
            <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
              <div className="text-center">
                <div className="w-16 h-16 bg-[#EEF2F8] border border-[#24365F]/20 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-sm">
                  <Check className="w-8 h-8 text-[#24365F]" />
                </div>
                <h3 className="font-['Fraunces'] text-2xl font-black text-[var(--ink)] italic">
                ...
                <p className="mt-2 text-[10px] font-black uppercase tracking-widest text-[var(--ink-3)]">
                  {currentResponse.remaining} sessões de repertório disponíveis hoje
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="p-8 rounded-[2rem] bg-[var(--paper)] border-2 border-[var(--red)]/20 relative group shadow-sm">
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      <h4 className="font-['Fraunces'] text-2xl font-black text-[var(--red)] tracking-tight italic">
                        {currentResponse.repertorio.titulo}
                      </h4>
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--ink-3)]">
                        {currentResponse.repertorio.autor}
                      </p>
                    </div>
                    <button
                      onClick={() =>
                        navigator.clipboard.writeText(
                          `${currentResponse.repertorio!.titulo} - ${currentResponse.repertorio!.autor}\n\n${currentResponse.repertorio!.exemplo}`,
                        )
                      }
                  ...
                  <div className="space-y-6">
                    <div>
                      <span className="text-[9px] font-black uppercase text-[var(--ink-3)] tracking-[0.2em] block mb-1">
                        Conceito Chave
                      </span>
                      <p className="text-sm font-bold text-[var(--ink)] leading-relaxed">
                        {currentResponse.repertorio.ideia}
                      </p>
                    </div>
                    <div>
                      <span className="text-[9px] font-black uppercase text-[var(--ink-3)] tracking-[0.2em] block mb-1">
                      ...
                      <p className="text-sm font-bold text-[var(--ink)] leading-relaxed">
                        {currentResponse.repertorio.relacao}
                      </p>
                    </div>
                    <div className="p-6 rounded-2xl bg-[var(--paper-2)] border border-[var(--line)] shadow-inner italic">
                      <span className="text-[9px] font-black uppercase text-[var(--red)] tracking-[0.2em] block mb-2 not-italic">
                        Exemplo no Texto
                      </span>
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    onClick={onClose}
                    className="flex-1 rounded-xl bg-[#16213A] py-4 text-[10px] font-black uppercase tracking-[0.2em] text-white shadow-lg transition-all hover:scale-105 hover:bg-[#24365F]"
                  >
                    FECHAR
                  </button>
                </div>
...
function StatCard({ icon: Icon, label, value, onClick, color }: any) {
  return (
    ...
    >
      <div
        className={`p-4 rounded-2xl ${color} mb-4 group-hover:scale-110 transition-transform shadow-sm`}
      >
        <Icon className="w-8 h-8" />
      </div>
      <span className="text-[9px] font-black uppercase tracking-[0.2em] text-[var(--ink-3)] mb-1">
        {label}
      </span>
...
function LockedLibraryOffer({
  titulo,
  descricao,
  itens,
  onBuy,
  onSeePlans,
}: LockedLibraryOfferProps) {
  return (
    <div className="relative -mt-2">
      <div className="rounded-[2.5rem] border-2 border-[var(--red)]/40 bg-[var(--paper)] p-6 md:p-10 shadow-[0_30px_60px_-15px_rgba(196,50,42,0.15)] relative overflow-hidden">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--red)] text-white text-[10px] font-black uppercase tracking-widest mb-6 shadow-sm">
          <Sparkles className="w-3.5 h-3.5 text-white animate-pulse" /> Acesso liberado no Combo
          Nota 1000
        </div>

        <h3 className="font-['Fraunces'] text-2xl md:text-4xl font-black tracking-tight mb-3 text-[var(--ink)] italic">
          {titulo}
        </h3>
        <p className="text-base text-[var(--ink-2)] font-medium leading-relaxed mb-8 max-w-2xl">
          {descricao}
        </p>
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
          {itens.map((item) => (
            <li
              key={item}
              className="flex items-start gap-3 text-sm md:text-base font-bold text-[var(--ink)]"
            >
              <span className="mt-0.5 h-5 w-5 shrink-0 rounded-full bg-[#24365F] text-white text-[10px] font-black flex items-center justify-center shadow-sm">
                ✓
              </span>
              <span>{item}</span>
            </li>
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-8 pt-8 border-t border-[var(--line)]">
          <div>
            <p className="whitespace-nowrap text-sm text-[var(--ink-3)] line-through font-bold italic">
              De R$ 59,90
            </p>
            <p className="whitespace-nowrap text-5xl font-black text-[var(--ink)] leading-none mt-1 tracking-tight">
              R$ 39,00
            </p>
            <p className="text-[10px] text-[var(--red)] font-black uppercase tracking-[0.2em] mt-3">
          ...
          <div className="flex-1 flex flex-col sm:flex-row gap-3 md:justify-end">
            <button
              onClick={onBuy}
              className="rounded-2xl bg-[#16213A] px-8 py-5 text-sm font-black uppercase tracking-[0.15em] text-white shadow-[0_20px_40px_-10px_rgba(22,33,58,0.5)] transition-all hover:scale-[1.02] hover:bg-[#24365F] active:scale-95"
            >
...
function ProgressSection({ essays, onGoToCorrection }: ProgressSectionProps) {
  const progress = buildEssayProgress(essays);
      ...
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="text-center py-20 border-2 border-dashed border-[var(--line)] rounded-[2.5rem] bg-[var(--paper-2)]/30">
          ...
          <button
            ...
            className="mt-4 text-[var(--red)] font-black hover:underline underline-offset-4"
          >
  ...
  const cards = [
    ...
    { label: "Melhor nota", valor: melhor, cor: "text-[#24365F]" },
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-8">
        <h2 className="font-['Fraunces'] text-3xl font-black flex items-center gap-3 text-[var(--ink)] italic">
          <TrendingUp className="w-8 h-8 text-[#24365F]" />
          Meu Progresso
        </h2>
        <p className="text-[var(--ink-2)] mt-2 font-medium">
          Acompanhe a evolução das suas notas e onde você mais precisa treinar.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {cards.map((c) => (
          <div
            key={c.label}
            className="rounded-2xl border border-[var(--line)] bg-[var(--paper-2)]/50 p-5 shadow-sm"
          >
            <p className="text-[10px] uppercase tracking-[0.2em] text-[var(--ink-3)] font-black mb-2">
              {c.label}
            </p>
      ...
      <div className="rounded-[2rem] border border-[var(--line)] bg-[var(--paper)] p-4 md:p-8 mb-8 shadow-sm">
        <h3 className="font-['Fraunces'] text-xl font-black mb-1 text-[var(--ink)]">
          Evolução das notas
        </h3>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData} margin={{ top: 8, right: 8, left: -20, bottom: 0 }}>
              ...
              <XAxis
                dataKey="nome"
                stroke="var(--ink-3)"
                tick={{ fill: "var(--ink-3)", fontWeight: 700 }}
                fontSize={12}
              />
              <YAxis
                domain={[0, 1000]}
              ...
              <Line
                ...
                stroke="var(--red)"
                strokeWidth={3}
                dot={{ r: 4, fill: "var(--red)", stroke: "var(--red)" }}
      ...
      <div className="rounded-[2rem] border border-[var(--line)] bg-[var(--paper)] p-4 md:p-8 shadow-sm">
        ...
        <p className="text-sm text-[var(--ink-2)] font-bold mb-6 italic">
          Cada competência vale até 200 pontos no ENEM.
        </p>
        <div className="h-64 w-full">
          <ResponsiveContainer width="100%" height="100%">
