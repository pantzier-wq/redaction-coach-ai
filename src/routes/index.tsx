...
function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[var(--paper)] text-[var(--ink)] font-['Public_Sans'] selection:bg-[var(--red-soft)] selection:text-[var(--red)]">
      ...
      <span className="sr-only">'"Você chutou 800 a 900. Sua nota real é:\n\n640/1000\n\nSão 260 pontos de diferença entre o que você achava e o que a banca veria.\"\n\nNao foi feito essa parte apos a analsie que eu falei, ela vai ser feita parcialmente no começo falando a nota e a C1 logo em seguida um botao pra ver as proximas competencias e nisso vai aparecer os planos, so depois da pessoa pagar ela vai ser direcionada apos o cehckout pra a pagina de cadastro/ login.\n\n\"Você treinou com Nenhuma ainda redações, mas nenhuma foi corrigida de verdade. Sem feedback real, você está apenas repetindo os mesmos erros.\"\n\nEsse texto a cima vou de uma das analises que fiz do quis perceba que tem erro ortografico no contexto, se tiver em outros tbm corrija.\n\nNo print da analise quando aparece a competencia 4 e 5 elas deparecem ali embaixo organize pra aparecer todas sem ficar poluido e coloque do lado delas o check e nao a bolinha' (on element 'body' at '/src/routes/index.tsx:1')</span>
